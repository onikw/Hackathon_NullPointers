...
export default function ElectricCarsInput() {
    ...
    return (
      <div className="flex flex-row gap-6 p-4  border-gray-300 rounded-lg bg-gray-600 relative border-4">

          <div
            className="absolute -top-3 left-1/2 transform -translate-x-1/2 w-10 h-4 bg-gray-500 border-2 border-gray-300 rounded-t-md"></div>
